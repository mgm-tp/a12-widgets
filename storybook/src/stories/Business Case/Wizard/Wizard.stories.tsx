...
import { Wizard, Icon, InteractionHintConfigProvider, Typography } from "@com.mgmtp.a12.widgets/widgets-core";
...
export const Default: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"A minimal Wizard with previous/next navigation. Click a step or the navigation buttons to move between steps. Step titles are surfaced via the browser's native tooltip."
			}
		}
	}
};
