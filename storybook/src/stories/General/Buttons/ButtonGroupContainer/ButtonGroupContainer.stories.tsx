...
import { ButtonGroupContainer, Button, Icon, InteractionHintConfigProvider } from "@com.mgmtp.a12.widgets/widgets-core";

const meta: Meta<typeof ButtonGroupContainer> = {
	title: "General/Buttons/ButtonGroupContainer",
