...
export const ResizeableApplicationFrameExample = ({
	resizeOptions
}: {
	resizeOptions: {
		minWidth: string | number;
		maxWidth: string | number;
		removeSubWidth?: boolean;
	};
}) => {
	const properties = {
		id: "test-id",
	...
	return (
		<ApplicationFrame
			...
			sub={{ content: properties.sub, style: { width: !resizeOptions.removeSubWidth ? 500 : undefined } }}
			content={{ content: properties.content, style: properties.style }}
			subResizableOptions={resizeOptions}
			subExpanded={true}
