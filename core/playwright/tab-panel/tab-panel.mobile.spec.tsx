...
import { TabPanelExceedTabExample } from "./tab-panel.stories.js";

test.describe("Mobile Tab Panel", () => {
	test("Should close the sub tab list when pressing Enter on a sub tab item", async ({
		...
		await firstItemOnSubMenu.focus();
		await page.keyboard.press(Key.Enter);

		await expect(subTab).not.toBeVisible();
	});
});
