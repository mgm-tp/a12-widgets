...
const getFormatedIconList = (fileName) => {
	const content = JSON.parse(fs.readFileSync(fileName, "utf-8"));

	const updatedList = getUpdatedIconList();

	const result = [];

	content.icons.forEach((curr) => {
		// Some icon of google fonts doesn't exist so we need to compare them with the current version of material icons
		if (curr.name !== undefined && updatedList.includes(curr.name)) {
			const nextValue = [
				{
					label: curr.name,
	...
	// Data will be exported into ./icon-with-codepoint.ts
	fs.writeFileSync("icon-with-codepoint.ts", JSON.stringify(result));
	console.log("success");
};

const getUpdatedIconList = () => {
	/**
	 * List of updated icon
	 * See more here https://github.com/google/material-design-icons/blob/master/update/current_versions.json
	 */
	const currentVersion = {
		...
		"action::extension": 6,
		"action::face": 6,
		"action::face_unlock": 5,
		"action::fact_check": 8,
		"action::favorite": 6,
		"action::favorite_border": 7,
		"action::feedback": 6,
		"action::file_present": 5,
		"action::filter_alt": 5,
		"action::filter_list_alt": 5,
		...
		"action::lock_clock": 6,
		"action::lock_open": 6,
		"action::lock_outline": 8,
		"action::login": 5,
		"action::logout": 6,
		"action::loyalty": 6,
		"action::mark_as_unread": 5,
		...
		"action::rowing": 8,
		"action::rule": 2,
		"action::saved_search": 6,
		"action::schedule": 7,
		"action::schedule_send": 8,
		"action::search": 7,
		"action::search_off": 6,
		"action::segment": 5,
		"action::send_and_archive": 5,
		"action::settings": 7,
		...
		"action::theaters": 6,
		"action::thumb_down": 7,
		"action::thumb_down_off_alt": 7,
		"action::thumb_up": 7,
		"action::thumb_up_off_alt": 7,
		...
		"communication::app_registration": 5,
		...
		"content::archive": 7,
		"content::attribution": 4,
		"content::backspace": 6,
		"content::ballot": 8,
		"content::biotech": 5,
		"content::block": 6,
		"content::block_flipped": 7,
		"content::bolt": 5,
		"content::calculate": 5,
		"content::clear": 6,
		...
		"content::reply_all": 7,
		"content::report": 7,
		"content::report_gmailerrorred": 5,
		...
		"device::battery_charging_20": 6,
		"device::battery_charging_30": 6,
		"device::battery_charging_50": 5,
		"device::battery_charging_60": 6,
		"device::battery_charging_80": 6,
		"device::battery_charging_90": 6,
		...
		"device::mobile_off": 6,
		"device::network_cell": 8,
		"device::network_wifi": 8,
		"device::nfc": 6,
		"device::reset_tv": 5,
		...
		"device::screen_search_desktop": 5,
		"device::sd_storage": 6,
		"device::send_to_mobile": 5,
		"device::settings_system_daydream": 6,
		"device::signal_cellular_0_bar": 7,
		"device::signal_cellular_1_bar": 5,
		"device::signal_cellular_2_bar": 6,
		"device::signal_cellular_3_bar": 6,
		"device::signal_cellular_4_bar": 6,
		"device::signal_cellular_alt": 6,
		"device::signal_cellular_connected_no_internet_0_bar": 6,
		"device::signal_cellular_connected_no_internet_1_bar": 6,
		"device::signal_cellular_connected_no_internet_2_bar": 6,
		"device::signal_cellular_connected_no_internet_3_bar": 6,
		...
		"device::signal_wifi_0_bar": 7,
		"device::signal_wifi_1_bar": 6,
		"device::signal_wifi_1_bar_lock": 6,
		"device::signal_wifi_2_bar": 6,
		"device::signal_wifi_2_bar_lock": 6,
		"device::signal_wifi_3_bar": 6,
		"device::signal_wifi_3_bar_lock": 6,
		...
		"editor::format_color_fill": 7,
		"editor::format_color_reset": 5,
		"editor::format_color_text": 7,
		...
		"editor::money_off": 6,
		"editor::money_off_csred": 5,
		"editor::multiline_chart": 6,
		"editor::notes": 5,
		"editor::padding": 6,
		"editor::pie_chart": 5,
		"editor::pie_chart_outline": 4,
		"editor::pie_chart_outlined": 5,
		"editor::post_add": 5,
		"editor::publish": 6,
		...
		"file::download": 4,
		"file::download_done": 4,
		"file::drive_file_move": 9,
		"file::drive_file_move_outline": 6,
		"file::drive_file_rename_outline": 6,
		"file::drive_folder_upload": 6,
		"file::file_download": 6,
		"file::file_download_done": 6,
		"file::file_upload": 6,
		"file::folder": 6,
		"file::folder_open": 6,
		...
		"image::audiotrack": 6,
		"image::auto_awesome": 9,
		"image::auto_awesome_mosaic": 9,
		"image::auto_awesome_motion": 9,
		"image::auto_fix_high": 9,
		"image::auto_fix_normal": 9,
		"image::auto_fix_off": 8,
		"image::auto_stories": 8,
		"image::bedtime": 7,
		...
		"image::face_retouching_natural": 6,
		"image::filter": 6,
		"image::filter_1": 6,
		"image::filter_2": 6,
		"image::filter_3": 6,
		...
		"image::looks_two": 6,
		"image::loupe": 6,
		"image::mic_external_off": 6,
		"image::mic_external_on": 6,
		"image::monochrome_photos": 5,
		"image::motion_photos_off": 9,
		...
		"image::panorama_horizontal_select": 6,
		"image::panorama_photosphere": 6,
		"image::panorama_photosphere_select": 7,
		"image::panorama_vertical": 7,
		"image::panorama_vertical_select": 7,
		"image::panorama_wide_angle": 7,
		"image::panorama_wide_angle_select": 7,
		"image::photo": 6,
		"image::photo_album": 6,
		"image::photo_camera": 6,
		"image::photo_camera_back": 6,
		"image::photo_camera_front": 6,
		...
		"maps::attractions": 5,
		"maps::badge": 6,
		"maps::bakery_dining": 6,
		"maps::beenhere": 6,
		"maps::bike_scooter": 5,
		"maps::breakfast_dining": 6,
		"maps::brunch_dining": 6,
		"maps::bus_alert": 5,
		"maps::car_rental": 5,
		"maps::car_repair": 5,
		"maps::category": 6,
		...
		"maps::streetview": 6,
		"maps::subway": 5,
		"maps::takeout_dining": 6,
		"maps::taxi_alert": 5,
		"maps::terrain": 6,
		"maps::theater_comedy": 6,
		"maps::traffic": 6,
		"maps::train": 5,
		"maps::tram": 5,
		...
		"navigation::assistant_direction": 5,
		"navigation::assistant_navigation": 5,
		...
		"navigation::offline_share": 6,
		"navigation::payments": 6,
		"navigation::pivot_table_chart": 6,
		...
		"navigation::waterfall_chart": 6,
		"navigation::west": 2,
		"notification::account_tree": 6,
		"notification::adb": 6,
		"notification::add_call": 4,
		...
		"notification::do_disturb": 4,
		"notification::do_disturb_alt": 5,
		"notification::do_disturb_off": 4,
		"notification::do_disturb_on": 4,
		"notification::do_not_disturb": 6,
		"notification::do_not_disturb_alt": 7,
		"notification::do_not_disturb_off": 6,
		"notification::do_not_disturb_on": 6,
		...
		"notification::imagesearch_roller": 6,
		...
		"notification::no_encryption_gmailerrorred": 4,
		...
		"notification::sd_card_alert": 5,
		"notification::sim_card_alert": 6,
		"notification::sms": 6,
		...
		"social::plus_one": 6,
		"social::poll": 6,
		"social::precision_manufacturing": 4,
		"social::psychology": 5,
		"social::public": 6,
		"social::public_off": 3,
		"social::recommend": 6,
		"social::reduce_capacity": 1,
		"social::remove_moderator": 6,
		"social::sanitizer": 1,
		"social::school": 6,
		"social::science": 5,
		"social::self_improvement": 5,
		"social::sentiment_dissatisfied": 5,
		"social::sentiment_neutral": 5,
		...
		"toggle::star_border_purple500": 5,
		"toggle::star_half": 9,
		"toggle::star_outline": 5,
		"toggle::star_purple500": 5,
		"toggle::toggle_off": 6,
		"toggle::toggle_on": 6
	};

	return Object.keys(currentVersion).map((icon) => icon.slice(icon.indexOf("::") + 2, icon.length));
};
...
async function main() {
	/**
	 * Replace with your file name that downloaded from https://fonts.google.com/metadata/icons
	 */
	getFormatedIconList("json.txt");
}
