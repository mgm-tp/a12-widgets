 ...
 * Uses the new API with leftSlotButtons and rightSlotButtons.
 * @module
 */
...
import type { ButtonProps as OriginalButtonProps } from "../../../button/main/button.api.js";
import type { QuickAccessButtonProps } from "../../../quick-access-button/main/quick-access-button.api.js";

/**
 * The props of ButtonGroupContainerNew using the modern API.
 */
export interface ButtonGroupContainerNewProps extends Styleable, Identifiable, Container {
	 ...
	 */
	rightSlotButtons?: ButtonGroupContainerNewProps.ButtonProps[];

	/**
	 * Additional props for the {@link ButtonGroup} of {@link leftSlotButtons}.
	 *
	...
	/**
	 * Additional props for the {@link ButtonGroup} of {@link rightSlotButtons}.
	 *
	 * *Note:* some props such as children, alignment, popupMenuIcon and responsive
	 * will not be available for this additional props because they are calculated internally
	 */
	rightSlotProps?: ButtonGroupContainerNewProps.ButtonGroup;
	...
	/**
	 * Additional HTML attributes to be applied to the popup menu's portal element when responsive behavior is enabled.
	 * This is useful for customizing the popup menu's DOM properties, such as applying custom styles or data attributes.
	 *
...
export namespace ButtonGroupContainerNewProps {
	...
	export type ButtonProps = OriginalButtonProps | QuickAccessButtonProps;
}
