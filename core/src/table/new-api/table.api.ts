...
/** @deprecated since version 38.2.0. Use {@link ColumnResizeEventHandler} instead. */
export type ResizeEventHandler<ColumnType> = ColumnResizeEventHandler<ColumnType>;
...
export interface ColumnResizingOptions<ColumnType> {
	 ...
	 */
	onEndResize?: ResizeEventHandler<ColumnType>;
}
