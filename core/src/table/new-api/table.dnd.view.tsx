...
import { StyledTableBodyRow } from "../main/template/table.body-row.tpl.view.js";
...
export namespace DnDTable {
	...
	DndBodyRow.displayName = "DnDTable.DnDBodyRow";
	...
	DragSource.displayName = "DnDTable.DragSource";
	...
	DropTarget.displayName = "DnDTable.DropTarget";
	...
	DragPreview.displayName = "DnDTable.DragPreview";
