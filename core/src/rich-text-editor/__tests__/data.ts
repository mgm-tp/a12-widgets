...
export const REGULAR_LINKS = `My http://example.com site
...
export const PROTOCOL_LINKS = `//localhost
//test.123
http://localhost:8000?
% Other protocols
...
export const FUZZY_LINKS = `test.example@http://vk.com
...
export const LINKS_SURROUNDED_BY_SPECIAL_CHARACTERS = `(Scoped http://example.com/foo_bar)
...
export const LINKS_WITH_TRAILING_DASHES = `http://www.bloomberg.com/news/articles/2015-06-26/from-deutsche-bank-to-siemens-what-s-troubling-germany-inc-
...
export const EMAILS = `test."foo".bar@gmail.co.uk!
"test@example.com"
name@example.com
...
export const INTERNATIONAL_LINKS = `http://✪df.ws/123
...
export const NOT_LINKS = `example.invalid
example.invalid/
http://.example.com
http://-example.com
hppt://example.com
...
export const misspelledWordsSampleText = `developrs sdevelopr sdeveloprx developr javescript developrr .developr. developr_developr ,developr, ;developr; :javescript: 'javecript' "javescript" (developrr) [developrr] {developrr} <javescript>`;

export const tooltipWordsSampleText = `mgm-tp .mgm-tp. ,mgm-tp, ;mgm-tp; :mgm-tp: 'mgm-tp' "mgm-tp" (mgm-tp) [mgm-tp] {mgm-tp} <mgm-tp>`;
