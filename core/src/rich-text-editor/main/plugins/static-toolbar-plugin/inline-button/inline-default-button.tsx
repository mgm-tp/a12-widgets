...
import { createInlineButton } from "./inline-button.view.js";

export const BoldButton = createInlineButton({
	nodeFormatType: "bold",
	icon: <Icon iconTheme="outlined">format_bold</Icon>,
	title: (languageContext) => languageContext.pluginEditorTitles?.boldButton
});

export const ItalicButton = createInlineButton({
	nodeFormatType: "italic",
	icon: <Icon iconTheme="outlined">format_italic</Icon>,
	title: (languageContext) => languageContext.pluginEditorTitles?.italicButton
});
