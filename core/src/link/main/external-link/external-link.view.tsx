...
import type { ExternalLinkProps } from "./external-link.api.js";
...
export const ExternalLink: FC<ExternalLinkProps> = ({
	...
	const linkTitle = title || languageContext.linkTitles?.externalLinkTitle;

	return (
		<Link
			className={joinClassNames(addPrefix("link--external"), className)}
			title={linkTitle}
			target={target}
			{...rest}
		>
