...
export const wizardConfig = (theme: BaseThemeType): WizardConfigType => {
	...
	return {
		...
		content: {
			wrapper: {
				nonIconPadding: `${spacing.horizontalSpacing.horizWhiteSpacingxs + 4}px 0`,
		...
		step: {
			...
			margin: `-1px ${-spacing.spacing.spacingSm}px -1px 0`,
