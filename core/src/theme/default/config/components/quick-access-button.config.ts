...
export const quickAccessButtonConfig = (theme: BaseThemeType): QuickAccessButtonConfigType => {
	const { colors, spacing, typography } = theme;

	return {
		buttonIconFontSize: typography.fontSize.bigFontSize,
		...
		secondary: {
			border: `2px solid ${colors.divider.color}`,
			boxShadow: "none",
			disabled: {
