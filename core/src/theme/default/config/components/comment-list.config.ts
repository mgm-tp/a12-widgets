...
export const commentListConfig = (theme: BaseThemeType): CommentListConfigType => {
	const {
	...
	return {
		...
		minHeight: `${spacing.spacing2Xl}px`,
		children: {
			left: `${horizontalSpacing.horizWhiteSpacingsm}px`,
			right: `${verticalSpacing.vertWhiteSpacingsm}px`,
			bottom: 0,
