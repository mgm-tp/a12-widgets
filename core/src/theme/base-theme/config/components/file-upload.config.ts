...
const defaultFileUploadConfig = (theme: BaseThemeCore): FileUploadConfigType => {
	...
	return {
		...
		content: {
			...
			childBorder: `${theme.border.width.thin} solid ${colors.divider.color}`,
			loadingBorder: `${theme.border.width.thin} solid ${colors.divider.color}`,
...
export const fileUploadOverrides = (theme: BaseThemeCore): DeepPartial<FileUploadConfigType> => {
	const colors = theme.colors;
	...
	return {
		...
		content: {
			...
			childBorder: `${theme.border.width.medium} solid ${colors.divider.color}`,
			loadingBorder: `${theme.border.width.medium} solid ${colors.divider.color}`
		},
		hover: {
			border: `${theme.border.width.medium} solid ${colors.interaction.hover.color}`,
			color: colors.interaction.hover.color
...
export const fileUploadConfig = (theme: BaseThemeCore) =>
	mergeConfig(defaultFileUploadConfig(theme), fileUploadOverrides(theme));
