...
export const commonButtonConfigs = (theme: BaseThemeCore) => {
	...
	return {
		...
		buttonInvertedBG: colors.interaction.touchOverlay,
		buttonInvertedBGDark: colors.interaction.touchOverlayDark
	};
};

const defaultGetButtonStyles = (theme: BaseThemeCore): ButtonConfigType => {
	...
	return {
		...
		invertPrimary: {
			...
			interaction: {
				...
				focus: {
					...
					outline: `${theme.border.width.thin} dotted ${colors.interaction.focus.colorInverted}`,
					textDecoration: "none"
				},
				hover: {
					background: buttonConfigs.buttonInvertedBG,
		...
		invertIcon: {
			activated: {
				background: buttonConfigs.buttonInvertedBGDark,
				borderRadius: theme.border.radius.md,
				color: colors.text.invertedColor,
				interaction: {
					active: {
...
const _overrideCommonButtonConfigs = (theme: BaseThemeCore) => {
	const colors = theme.colors;
...
export const buttonOverrides = (theme: BaseThemeCore): DeepPartial<ButtonConfigType> => {
	const buttonConfigs = _overrideCommonButtonConfigs(theme);
	const spacing = theme.spacing;
	const colors = theme.colors;
...
export const getButtonStyles = (theme: BaseThemeCore) =>
	mergeConfig(defaultGetButtonStyles(theme), buttonOverrides(theme));
