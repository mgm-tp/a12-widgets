...
export const statusConfig = (theme: BaseThemeCore): StatusConfigType => {
	...
	return {
		...
		icon: {
			height: `${spacing.spacing.spacingLg - spacing.spacing.spacing3xs}px`,
			lineHeight: `${spacing.verticalSpacing.vertWhiteSpacingmd}px`
		},
		padding: `${spacing.spacing.spacing3xs}px ${
			spacing.horizontalSpacing.horizWhiteSpacingxs + spacing.spacing.spacing3xs
		}px`,
		text: {
