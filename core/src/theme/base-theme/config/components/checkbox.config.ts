...
const defaultCheckboxConfig = (theme: BaseThemeCore): CheckboxConfigType => {
...
export const checkboxOverrides = (theme: BaseThemeCore) => {
	const colors = theme.colors;
	...
	return {
		readOnly: {
			...
			checkedBorderColor: colors.graphicSecondaryColorDark
		}
	};
};

export const checkboxConfig = (theme: BaseThemeCore) =>
	mergeConfig(defaultCheckboxConfig(theme), checkboxOverrides(theme));
