...
export type TextFieldConfigType = {
	 ...
	 **/
	mobile?: { fontSize: string; height: string };

	textSuffix: { background: string; fontSize: string; minWidth: string; padding: string };
};

export const textFieldConfig = (theme: BaseThemeCore): TextFieldConfigType => {
