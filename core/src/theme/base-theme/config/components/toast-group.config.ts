...
export const toastGroupConfig = (theme: BaseThemeCore): ToastGroupConfigType => {
	const {
	...
	return {
		...
		width: `${7 * spacing.spacing2Xl + theme.spacing.baseSpacing.BASE}px`,
		...
		stacked: {
			...
			toolbar: {
				...
				boxShadow: `0px 0px 4px 0 ${rgba(colors.boxShadowBackground, theme.opacity.low)}`,
