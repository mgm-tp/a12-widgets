...
export const LabelConfig = (theme: BaseThemeCore) => {
...
export const CommonInputConfig = (theme: BaseThemeCore): CommonInputConfigType => {
	const colors = theme.colors;
	const typography = theme.typography;
	const baseInputStyles = theme.baseInputStyles;
