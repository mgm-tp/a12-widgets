...
const textTransformStyle = (val: string) => css`
	&${StyledButton} {
		text-transform: ${val};
	}
...
export const textTransformHelper = css`
	.${addPrefix("h")} {
		&_unsetTextTransform {
			${textTransformStyle("unset")}
		}
		&_capitalizeTextTransform {
			${textTransformStyle("capitalize")}
		}
		&_lowercaseTextTransform {
			${textTransformStyle("lowercase")}
		}
		&_uppercaseTextTransform {
