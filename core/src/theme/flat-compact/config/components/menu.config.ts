...
export const menuFlatCompactConfig = (theme: FlatCompactThemeType) => {
	...
	return {
		...
		link: {
			minHeight: `${spacing.spacing.spacingXl + 1}px`
		},
		mainLayer: {
			horizontalPadding: `0 ${spacing.horizontalSpacing.horizWhiteSpacingsm}px`,
			verticalBG: GeneralFlatColorsConfig.blue98
		},
		subLayer: {
			background: GeneralFlatColorsConfig.blue98,
			verticalBG: GeneralFlatColorsConfig.blue98
		},
		group: {
