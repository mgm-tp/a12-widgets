...
export const datePickerCompactConfig = (theme: CompactThemeType) => {
	const { spacing } = theme;
	...
	return {
		caption: {
			fieldSelect: {
				arrowIcon: {
					width: spacing.spacing.spacingSm + spacing.spacing.spacingMd + 1 + "px"
				}
			},
			selectInput: {
		...
		day: {
			...
			size: spacing.spacing.spacingSm + spacing.spacing.spacingMd + 1 + "px"
		},
		navButton: {
			size: spacing.spacing.spacingSm + spacing.spacing.spacingMd + 1 + "px"
		},
		...
		weekday: {
			padding: `${spacing.verticalSpacing.vertWhiteSpacingmd + 0.5}px 0 calc(${
				spacing.verticalSpacing.vertWhiteSpacinglg + 1.5
			}px / 3)`,
			width: spacing.spacing.spacingSm + spacing.spacing.spacingMd + 1 + "px"
		}
	};
