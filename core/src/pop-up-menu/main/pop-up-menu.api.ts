...
export interface PopUpMenuProps extends Container, Styleable, Identifiable, DataRole, Ref<HTMLDivElement> {
	 ...
	 * Available reasons include item clicks, outside clicks, ESC, SPACE, close button clicks and programmatic closes (when the popup is controlled and closed from outside the component).
	 *
