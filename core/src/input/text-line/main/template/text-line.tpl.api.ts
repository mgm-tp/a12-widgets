...
/**
 * The text-line widget wraps the HTML input element and provide more functionality
 * such as tooltips, icon and action buttons.
 * It has no intrinsic state.
 * @module
 */

import type { ReactNode, KeyboardEvent, RefCallback, HTMLProps, MouseEvent, ChangeEvent } from "react";
...
export interface TextLineStatelessProps
