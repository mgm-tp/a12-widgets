...
export const inputProps: AutocompleteProps = {
	id: "test-id",
	label: "Basic Autocomplete",
	inputPlaceHolder: "Autocomplete placeholder",
	suffixes: <Button icon={<Icon>description</Icon>} />,
	tooltips: <HintTooltip text="Autocomplete with hint tooltip" />,
	errorMessage: "Error message",
	warningMessage: "Warning message",
	infoMessage: "Info message",
	ariaDescribedby: "warning-tooltip",
	ariaLabelledby: "warning-tooltip",
