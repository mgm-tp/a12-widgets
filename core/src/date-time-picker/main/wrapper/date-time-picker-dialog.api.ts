...
export interface DateTimePickerDialogProps<T extends DateTimePickerProps> {
	/**
	 * The reference element that the picker will anchor to.
	 */
	referenceElement: HTMLElement;

	/**
	 * If true, the modal overlay can be closed by the outside click.
	 * @default true
	 */
