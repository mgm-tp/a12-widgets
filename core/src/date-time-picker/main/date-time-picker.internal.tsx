...
export type FooterProps = DatePickerFooterProps;

export function Footer(props: FooterProps): ReactElement<FooterProps> {
...
export interface HeaderProps extends Styleable, Identifiable, Container {
