 ...
 * @internal
 */
export class LegacyFilterSelector extends Component<FilterSelectorProps, FilterSelectorState> {
	static displayName = "LegacyFilterSelector";
	...
	private renderFilter(filter: FilterSelectorProps.FilterData, lastSelectedDivider?: boolean): ReactNode {
		...
		return (
			<LegacyFilterSelector.FilterItem
				key={filter.id}
				filter={filter}
				meta={filter.meta}
				disabled={this.props.disabled}
