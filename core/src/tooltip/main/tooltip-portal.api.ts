...
export interface TooltipPortalProps {
	/**
	 * Reference to the element to attach the tooltip to
	 */
	...
	/**
	 * Data role for the tooltip container
	 */
	dataRole?: string;

	/**
	 * Data role for the tooltip content
	 */
	tooltipContentDataRole?: string;

	/**
	 * Callback to determine if tooltip should be shown
	 * Return true to show the tooltip, false to hide it
	 */
