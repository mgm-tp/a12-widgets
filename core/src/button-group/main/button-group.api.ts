 ...
 * and position them together to either left, right or vertical.
 * @module
 */
import type { Identifiable, Styleable, Container, Ref } from "../../common/main/base-props.js";

export interface ButtonGroupProps extends Styleable, Identifiable, Container, Ref<HTMLDivElement> {
	/**
