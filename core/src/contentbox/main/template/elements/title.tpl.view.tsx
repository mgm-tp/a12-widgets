...
import { StyledContentBoxTitleWrapper } from "../contentbox.tpl.styled.js";
...
export function TitleTpl({
	...
	const className = joinClassNames(`${baseClassName}__title`, classNameProp);
