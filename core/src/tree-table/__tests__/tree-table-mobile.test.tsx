...
import { render, setupDevice } from "test-utils";
...
async function testMobileDragAndDrop(): Promise<void> {
...
describe("Tree table mobile tests", () => {
	afterEach(() => {
		vi.restoreAllMocks();
	});

	describe("Android mobile devices", () => {
		test("should drag and drop a tree node using touch", async () => {
			await page.viewport(375, 667);
			await testMobileDragAndDrop();
		});
	});

	describe("iOS mobile devices", () => {
		test("should drag and drop a tree node using touch", async () => {
