...
export function TextOutputWithAlignment(): ReactElement {
	return (
		// start code removal
		<StyledWrapper>
			<CodeSnippetGenerationWrapper>
				<TextOutput label="Text Output with left aligned by default">{shortText}</TextOutput>

				<TextOutput label="Text Output with center aligned" alignment="center">
					{shortText}
				</TextOutput>

				<TextOutput label="Text Output with right aligned" alignment="right">
					{shortText}
				</TextOutput>
			</CodeSnippetGenerationWrapper>
		</StyledWrapper>
