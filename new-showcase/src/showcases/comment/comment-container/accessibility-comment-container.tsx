...
import { Button, CommentContainer, Icon, Comment, CommentList, CssEllipsis } from "@com.mgmtp.a12.widgets/widgets-core";

import { comments } from "../shared-data.js";

export function AccessibilityCommentContainer(): ReactElement {
	...
	return (
		<>
			...
			{show && triggerButtonRef.current && (
				<CommentContainer
					id="accessibility-comment-container"
