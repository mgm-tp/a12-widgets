...
import { getDataByKey, Table, Icon } from "@com.mgmtp.a12.widgets/widgets-core";
...
export const CustomizationTableShowcase: FC = () => {
	...
	const cellStyling: CellStyleGetter<DataType, BaseColumnType<DataType>> = useCallback(
		({ column }): CellStyles => ({
	...
	const rowStyling: RowStyleGetter<DataType> = useCallback(
		({ row }): RowStyles => ({
