...
import type { BaseColumnType, SortOrder, SortState } from "@com.mgmtp.a12.widgets/widgets-core";
...
export const CrossTabulationShowcase: FC = () => {
	...
	const [sortState, setSortState] = useState<SortState<BaseColumnType<DataType>>>({});

	const onSort = useCallback((params: { column: BaseColumnType<DataType>; order: SortOrder }): void => {
		setSortState(params);
