...
import { DefaultTableComponentRenderers, Table, Button, Icon, provider } from "@com.mgmtp.a12.widgets/widgets-core";
...
export function DnDTableShowcase(): ReactElement {
	...
	const onDrop: TableDragDropOptions["onDrop"] = ({ dragItem, dropResult }) => {
		...
		return {
			bodyContentRenderer: (props) => {
				if (props.column.actionColumn) {
					return <Button icon={<Icon>delete</Icon>} title={`Delete ${props.row.index}`} />;
				}
