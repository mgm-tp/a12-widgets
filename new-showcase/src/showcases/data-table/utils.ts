...
import type { DataTableSortOrder, DataTableRowLoadingStatus } from "@com.mgmtp.a12.widgets/widgets-core/experimental";
...
export namespace Utils {
	...
	export type CompareFn<T> = (a: T, b: T, sortOrder?: DataTableSortOrder) => number;
	...
	export function updateRowLoadingStatusMap(
		map: Record<number, DataTableRowLoadingStatus>,
		range: { startIndex: number; stopIndex: number },
		status: DataTableRowLoadingStatus
	): Record<number, DataTableRowLoadingStatus> {
		const newMap = { ...map };
