...
const columns: DataTableColumn<UserDataType>[] = [
	{
		label: "ID",
		dataKey: "id",
		width: 0.5,
...
export function ScrollToNodeTableShowcase(): ReactElement {
	const scrollToNodeRef = useRef<DataTableScrollToNodeHandler | undefined>(undefined);
	...
	const rowStyling = useCallback(
		(params: { row: UserDataType }): DataTableRowStyles => {
