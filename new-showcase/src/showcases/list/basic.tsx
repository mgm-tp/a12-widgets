...
import { List, provider } from "@com.mgmtp.a12.widgets/widgets-core";
...
export function Basic(): ReactElement {
	return (
		// start code removal
		<div className={isPhone ? "-u-width-full" : "-u-width-2-5"}>
			<CodeSnippetGenerationWrapper namespaceOptions={[{ name: "List", subComponents: ["Item"] }]}>
				<List border>
					<List.Item text="List Item" />
					<List.Item text="List Item" selected />
					<List.Item text="List Item" divider />
					<List.Item text="List Item" readonly />
					<List.Item text="List Item" disabled />
				</List>
