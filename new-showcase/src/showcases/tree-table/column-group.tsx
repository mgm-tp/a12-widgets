...
import { provider, TreeTable } from "@com.mgmtp.a12.widgets/widgets-core";
import type {
...
// Column configuration with grouping - same as column-group tree table
...
const root = generateTreeTableNodes(true);

export const ColumnGroupTreeTable: FC = () => {
