...
export function AccessibilityCallout(): ReactElement {
	...
	return (
		<>
			...
			{show && referenceElement.current && (
				<Callout
					id="accessible-callout"
					referenceElement={referenceElement.current}
					closeOnClickReferenceElement={false}
					closeOnOutsideClick={provider.isDesktop()}
					onClose={handleClose}
					header={{
						title: <p id="callout-header-title">Accessibility Callout</p>,
						suffix: <Button icon={<Icon>close</Icon>} title="Close Callout" onClick={handleClose} />
					}}
					htmlAttributes={{
						"aria-label": "Accessibility Custom Label"
					}}
				>
