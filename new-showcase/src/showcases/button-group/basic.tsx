...
export function BasicShowcase(): ReactElement {
	return (
		<div className="-u-width-full">
			<p>Buttons are grouped horizontally by default.</p>
			<ButtonGroup>
			...
			<p>
				Buttons can be grouped vertically by setting the <code>vertical</code> property to true.
			</p>
			<ButtonGroup vertical style={{ width: "fit-content" }}>
				<Button label="Primary" primary />
				<Button label="Destructive" primary destructive />
				<Button label="Disabled" primary disabled />
			</ButtonGroup>
