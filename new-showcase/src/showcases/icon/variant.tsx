...
export function IconWithVariant(): ReactElement {
	return (
		<div className="-u-flex -u-flex-col">
			<ShowcaseFlexBox>
				<strong>Info: </strong>
				<Icon title="Info" variant="info">
					info
				</Icon>
			</ShowcaseFlexBox>
			<ShowcaseFlexBox>
			...
			<ShowcaseFlexBox>
				...
				<Icon title="Warning" variant="warning">
					warning
				</Icon>
			</ShowcaseFlexBox>
			<ShowcaseFlexBox>
				<strong>Error: </strong>
				<Icon title="Error" variant="error" iconTheme="custom">
					error
				</Icon>
			</ShowcaseFlexBox>
		</div>
