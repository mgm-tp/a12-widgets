...
const highlightedDayStyle = { backgroundColor: "rgb(255, 181, 128)" };
...
export const DateTimePickerInputWithAdditionalProps: FC = () => {
	...
	return (
		<DateTimeContext.Provider value={{ locale: de }}>
			<DateTimePickerInputWithTimeInput
				buttonIcon={<Icon>alarm</Icon>}
				inputLabel="Custom modifiers"
				pickerProps={{
					id: "date-time-input-custom-modifiers",
