...
import { TimePicker, TimePickerTpl, TimeUtils, PickerHeaderCloseButton } from "@com.mgmtp.a12.widgets/widgets-core";
...
export function CustomHeader(): ReactElement {
	return (
		<div className="-u-width-full">
			<TimePicker
				{...useTimePickerProps({ id: "custom-header" })}
				label="Time picker with custom header"
				customHeaderElement={(time, closeHandler): ReactNode => (
