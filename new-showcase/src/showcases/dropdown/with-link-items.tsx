...
import { Checkbox, DropDown, Link, Icon } from "@com.mgmtp.a12.widgets/widgets-core";
...
const items = [
	{ label: "John Doe" },
	{ label: "Paul Walters" },
	{ label: "Lola Sporer", disabled: true },
	{ label: "Malcolm Spencer" },
	{ label: "Naomi Jones" },
	{ label: "Christoper Kunde" },
	{ label: "Katelynn Schmidt" },
	{ label: "Hubert Davis" },
	{ label: "Vito Spencer" },
	{ label: "Kathryn Bernier" }
].map((item, index) => ({ ...item, tabIndex: 0, value: `value ${index}` }));

export function WithLinkItems(): ReactElement {
