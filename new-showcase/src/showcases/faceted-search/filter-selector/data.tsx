...
import type { FilterSelectorProps, FilterProps } from "@com.mgmtp.a12.widgets/widgets-core";
...
export const OPTIONS: FilterOption[] = [
	...
	{ label: "Option 4", active: false },
	{ label: "Option 5", active: false },
	{ label: "Option 6", active: false },
	{ label: "Option 7", active: false },
	{ label: "Option 8", active: false },
	{ label: "Option 9", active: false },
	{ label: "Option 10", active: false },
	{ label: "Option 11", active: false },
	{ label: "Option 12", active: false },
	{ label: "Option 13", active: false },
	{ label: "Option 14", active: false },
	{ label: "Option 15", active: false }
];

export const sectionData: SectionData[] = [
	{
		id: "frequently-used-filter",
		label: "Frequently Used Filter"
	}
];
...
export const contentInContentBox = loremIpsum({ units: "sentences", count: 30 });
