...
export const HelperTextCheckboxesShowcase: FC = () => {
	...
	return (
		<div className="-u-flex -u-items-center -u-flex-wrap -u-width-full" style={{ gap: 16 }}>
			...
			/>
			<CheckboxGroup
				label="Checkbox Group with Helper Text"
				helperText="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
