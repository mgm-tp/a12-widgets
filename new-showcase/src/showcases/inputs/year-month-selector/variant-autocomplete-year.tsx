...
export const YearMonthSelectorAutocompleteYear: FC = () => {
	...
	const handleYearBlur = (event: FocusEvent<HTMLInputElement>): void => {
		setYearError(validateYearOnBlur(event, { min: 2000, max: 2030 }));
	};

	return (
		<div className="-u-width-full">
			<YearMonthSelector
				label="Autocomplete Year Selector"
				id="autocomplete-year-month"
				month={month}
				year={year}
