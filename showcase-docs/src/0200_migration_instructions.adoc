...
include::generated/migration/migration-notes.adoc[]

include::generated/migration/codemod-instruction.adoc[]

include::generated/migration/patch-instruction.adoc[]

include::generated/migration/rich-text-editor-migration-notes.adoc[]

= Chart Widget to Recharts

:leveloffset: +1

include::generated/migration/chart-widget-to-recharts/migration-overview.adoc[]

include::generated/migration/chart-widget-to-recharts/bar-chart-migration.adoc[]

include::generated/migration/chart-widget-to-recharts/line-chart-migration.adoc[]

include::generated/migration/chart-widget-to-recharts/pie-chart-migration.adoc[]
